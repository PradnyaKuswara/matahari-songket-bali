...
<div class="app-menu">
    ...
    <a href="index.html" class="logo-box">
        <img src="{{ asset('assets/lunoz/images/logo-light.png') }}" class="logo-light h-6" alt="Light logo">
        <img src="{{ asset('assets/lunoz/images/logo-dark.png') }}" class="logo-dark h-6" alt="Dark logo">
    </a>
        ...
        <ul class="menu" data-fc-type="accordion">
            ...
            <li class="menu-item">
                <a href="index.html" class="menu-link waves-effect">
                    ...
                    <span class="badge bg-secondary rounded ms-auto text-white">01</span>
                </a>
            </li>

            <li class="menu-item">
                <a href="calendar.html" class="menu-link waves-effect">
