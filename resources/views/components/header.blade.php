...
<div class="navbar z-50 fixed shadow-sm  py-4 md:px-36" id="navbar">
    <div class="flex-1 gap-8 ">
        <a class="btn hover:bg-white btn-ghost text-xl">AAA</a>
        <ul class="menu menu-horizontal px-1 hidden md:flex text-xs">
            <li><a>Home</a></li>
            <li><a>Product</a></li>
            <li><a>About</a></li>
            <li><a>Dashboard</a></li>
    ...
    <div class="flex-none gap-2 md:gap-2 ">
        ...
        <div class="dropdown dropdown-end">
            <label class="swap swap-rotate btn btn-ghost btn-circle">
                <input id="mode" type="checkbox" class="theme-controller"/>
