            ...
            <td align="center" data-bgcolor="Body" bgcolor="#FFFFFF" data-composer>
                                        ...
                                        <table border="0" align="center" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr data-element="blue-paragraph" data-label="Paragraphs">
                                                <td class="center-text" data-text-style="Paragraphs" align="center"
                                                    ...
                                                    <singleline>
                                                        <div mc:edit data-text-edit>
                                                            This document serves as an invoice and order confirmation,
                                                            providing a detailed record of the purchase, including all
                                            ...
                                            <tr data-element="blue-order-number" data-label="Order number">
                                                <td align="center">
                                                    <!-- rwd-col -->
                                            ...
                                            <tr data-element="blue-order-number" data-label="Order number">
                                                <td height="20" style="font-size:20px;line-height:20px;"
                                                    data-height="Spacing under order number">&nbsp;</td>
                                            </tr>
                                                                ...
                                                                <table border="0" align="center" cellpadding="0"
                                                                    ...
                                                                    <tr data-element="blue-content-paragraph"
                                                                        ...
                                                                        <td class="center-text"
                                                                            ...
                                                                            <singleline>
                                                                                <div mc:edit data-text-edit>
                                                                                    {{ $content->transaction->generate_id }}
                                                                                </div>
                                                                            </singleline>
                                                                        </td>
                                                                    </tr>
                ...
                @foreach ($content->products as $product)
                    <table data-outer-table border="0" align="center" cellpadding="0" cellspacing="0"
                        ...
                        style="width:640px;max-width:640px;" data-module="blue-invoice-product-1">
                        <!-- blue-invoice-product-1 -->
                        <tr>
                                    ...
                                    <tr>
                                        <td align="center" bgcolor="#F8F8F8" data-bgcolor="Inner BgColor">
                                            ...
                                            <table border="0" cellpadding="0" cellspacing="0" align="center"
                                                ...
                                                <tr>
                                                    <td class="rwd-col" align="center" valign="top" width="65.52%"
                                                        style="width:65.52%;max-width:65.52%;">

                                                        <!-- column -->
                                                        <table border="0" cellpadding="0" cellspacing="0"
                                                            align="center" class="row container-padding"
                                                            width="90.63%" style="width:90.63%;max-width:90.63%;">
                                                            <tr data-element="blue-content-titles"
                                                                data-label="Titles">
                                                                <td class="center-text" data-text-style="Titles"
                                                                    align="left"
                                                                    style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:20px;line-height:24px;font-weight:400;font-style:normal;color:#333333;text-decoration:none;letter-spacing:0px;">
                                                                    <singleline>
                                                                        <div mc:edit data-text-edit>
                                                    ...
                                                    <td class="rwd-col" align="center" valign="top" width="31.03%"
                                                        ...
                                                        <table border="0" cellpadding="0" cellspacing="0"
                                                            align="center" class="row container-padding"
                                                            width="90.63%" style="width:90.63%;max-width:90.63%;">
                                                            <tr data-element="blue-content-option-1"
                                                            ...
                                                            <tr data-element="blue-content-option-1"
                                                                ...
                                                                <td height="20"
                                                                    style="font-size:20px;line-height:20px;"
                                                                    data-height="Spacing under 1st option">&nbsp;</td>
                                                            </tr>
                                                            <tr data-element="blue-content-option-2"
                                                                ...
                                                                <td class="center-text" data-text-style="Options"
                                                                    ...
                                                                    <singleline>
                                                                        <div mc:edit data-text-edit>
                                                                            <strong>Price:</strong>
                                                                            <br>Rp.{{ number_format($product->pivot->price, 2, ',', '.') }}
                                                                        </div>
                                                                    </singleline>
                                                                </td>
                                                            </tr>
                                                                ...
                                                                <table border="0" align="center" cellpadding="0"
                                                                    ...
                                                                    <tr data-element="blue-content-paragraph"
                                                                        ...
                                                                        <td class="center-text"
                                                                            ...
                                                                            <singleline>
                                                                                <div mc:edit data-text-edit>
                                                                                    Rp.{{ number_format($content->transaction->item_total_price, 2, ',', '.') }}
                                                                                </div>
                                                                            </singleline>
                                                                        </td>
                                                                    </tr>
                                                                ...
                                                                <table border="0" align="center" cellpadding="0"
                                                                    ...
                                                                    <tr data-element="blue-content-paragraph"
                                                                        ...
                                                                        <td class="center-text"
                                                                            ...
                                                                            <singleline>
                                                                                <div mc:edit data-text-edit>
                                                                                    Rp.{{ number_format($content->transaction->tax, 2, ',', '.') }}
                                                                                </div>
                                                                            </singleline>
                                                                        </td>
                                                                    </tr>
                                                                ...
                                                                <table border="0" align="center" cellpadding="0"
                                                                    ...
                                                                    <tr data-element="blue-content-paragraph"
                                                                        ...
                                                                        <td class="center-text"
                                                                            ...
                                                                            <singleline>
                                                                                <div mc:edit data-text-edit>
                                                                                    Rp.{{ number_format($content->transaction->shipping_price, 2, ',', '.') }}
                                                                                </div>
                                                                            </singleline>
                                                                        </td>
                                                                    </tr>
                                                                ...
                                                                <table border="0" align="center" cellpadding="0"
                                                                    ...
                                                                    <tr data-element="blue-content-paragraph"
                                                                        ...
                                                                        <td class="center-text"
                                                                            ...
                                                                            <singleline>
                                                                                <div mc:edit data-text-edit>
                                                                                    Rp.{{ number_format($content->transaction->total_price, 2, ',', '.') }}
                                                                                </div>
                                                                            </singleline>
                                                                        </td>
                                                                    </tr>
                                                                            ...
                                                                            <table border="0" align="center"
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td align="center" height="54"
                                                                                        ...
                                                                                        <singleline>
                                                                                            <a
                                                                                                href="{{ route('checkout.showPayment', $content) }}">
                                                                                                <div mc:edit
                                                                                                    data-text-edit>
                                                                                                    Pay Now
                                                                                                </div>
              ...
              <table border="0" cellpadding="0" cellspacing="0" align="center">
                <tr>
                  ...
                  <![endif]-->
                                                                            <singleline>
                                                                                <a href="{{ route('customer.dashboard.order.show', $content) }}"
                                                                                    mc:edit data-button
