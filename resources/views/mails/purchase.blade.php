...
<![endif]-->
    ...
    <style type="text/css" class="export-delete">
        ...
        .composer--mobile .m-height20 {
            font-sBarlowize: 20px !important;
            line-height: 20px !important;
            height: 20px !important;
        }
        ...
        <tr><!-- Outer Table -->
            <td align="center" data-bgcolor="Body" bgcolor="#FFFFFF" data-composer>
                                        ...
                                        <table border="0" align="center" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr data-element="blue-paragraph" data-label="Paragraphs">
                                                <td class="center-text" data-text-style="Paragraphs" align="center"
                                                    ...
                                                    <singleline>
                                                        <div mc:edit data-text-edit>
                                                            Thank you for shopping with Matahari Songket Bali. We are
                                                            thrilled to have you as our customer and hope
                                                            you are delighted with your recent purchase. We are
                                                            committed to providing you with the best quality
                ...
                <table data-outer-table border="0" align="center" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td height="10" style="font-size:10px;line-height:10px;" data-height="Spacing bottom">
                            &nbsp;</td>
                    </tr>
                </table>
                <!-- blue-title -->
                ...
                <table data-outer-table border="0" align="center" cellpadding="0" cellspacing="0"
                    class="outer-table row" role="presentation" width="640" style="width:640px;max-width:640px;"
                    data-module="blue-thank-you-box">
                    <!-- blue-thank-you-box -->
                    <tr>
                                ...
                                <tr>
                                    <td align="center" bgcolor="#F8F8F8" data-bgcolor="Inner BgColor">
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" align="center"
                                            ...
                                            <tr>
                                                <td class="rwd-col" align="center" valign="top" width="45%"
                                                    style="width:45%;max-width:45%;">

                                                    <!-- column -->
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        align="center" class="row container-padding" width="90.63%"
                                                        style="width:90.63%;max-width:90.63%;">
                                                ...
                                                <td class="rwd-col" align="center" width="10%" height="30"
                                                    style="width:10%;max-width:10%;height: 30px;">&nbsp;</td>
                                                <td class="rwd-col" align="center" valign="top" width="45%"
                                                    style="width:45%;max-width:45%;">
                ...
                <table data-outer-table border="0" align="center" cellpadding="0" cellspacing="0"
                    ...
                    style="width:640px;max-width:640px;" data-module="blue-send-email">
                    <!-- blue-send-email -->
                    <tr>
                    ...
                    <tr data-element="blue-ty-paragraph" data-label="Paragraphs">
                        <td class="center-text" data-text-style="Paragraphs" align="center"
                            ...
                            <singleline>
                                <div mc:edit data-text-edit>
                                    (For any questions you may have, <a href="mailto:mataharisongketbali@gmail.com"
                                        style="color:#4600ff;text-decoration: underline;">reply to this email</a>)
                                </div>
                            </singleline>
                        </td>
                    </tr>
