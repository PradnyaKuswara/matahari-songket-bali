        ...
        <tr><!-- Outer Table -->
            <td align="center" data-bgcolor="Body" bgcolor="#FFFFFF" data-composer>
                                        ...
                                        <table border="0" align="center" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr data-element="blue-subline" data-label="Sublines">
                                                <td class="center-text" data-text-style="Sublines" align="center"
                                                    style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:14px;line-height:24px;font-weight:900;font-style:normal;color:#4600ff;text-decoration:none;letter-spacing:1px;">
                                                    <singleline>
                                            ...
                                            <tr data-element="blue-headline" data-label="Headlines">
                                                <td class="center-text" data-text-style="Headlines" align="center"
                                                    ...
                                                    <singleline>
                                                        <div mc:edit data-text-edit>
                                                            Confirmation Order Succesfully
                                                        </div>
                                                    </singleline>
                                                </td>
                                            </tr>
                                            ...
                                            <tr data-element="blue-paragraph" data-label="Paragraphs">
                                                <td class="center-text" data-text-style="Paragraphs" align="center"
                                                    ...
                                                    <singleline>
                                                        <div mc:edit data-text-edit>
                                                            We hope this message finds you well. We would like to
                                                            confirm if your order has been safely
                                                            received. Please click the link below to confirm the
                                                            receipt. Kindly confirm the receipt of the goods before
                                                            [{{ $content->max_confirm->format('d F Y') }}]. If no
                                                            confirmation is received after due date, we
                                                            will assume that
                                                            the goods have been received successfully. You can track
                                                            your shipment by clicking on the link
                                                            below
                                                        </div>
                                                    </singleline>
                                                </td>
                                            ...
                                            <tr data-element="blue-bm-usercode" data-label="User Code">
                                                <td align="center">
                                                    ...
                                                    <table border="0" cellspacing="0" cellpadding="0"
                                                        ...
                                                        width="80%" style="width:80%;max-width:80%;">
                                                        <tr>
                                                            <td align="center" data-bgcolor="User Code"
                                                                bgcolor="#F8F8F8" style="border-radius: 0px;">
                                                                <!-- Content -->
                                                                <table border="0" cellspacing="0" cellpadding="0"
                                                                    role="presentation" align="center" class="row"
                                                                    width="100%" style="width:100%;max-width:100%;">
                                                                    ...
                                                                    <tr>
                                                                        <td class="center-text"
                                                                            data-text-style="Use Code" align="center"
                                                                            style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:22px;line-height:26px;font-weight:700;font-style:normal;color:#0387EC;text-decoration:none;letter-spacing:4px;">
                                                                            <singleline>
                                                                                <div mc:edit data-text-edit>
                                                                                    {{ $content->order->generate_id }}
                                                                                </div>
                                                                            </singleline>
                                                                        </td>
                                                                    </tr>
                                            ...
                                            <tr data-element="blue-bm-usercode" data-label="User Code">
                                                <td height="60" style="font-size:60px;line-height:60px;"
                                                    data-height="Spacing under user code">&nbsp;</td>
                                            </tr>
                                            ...
                                            <tr data-element="blue-shipping-details" data-label="Shipping details">
                                                <td align="center">
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        align="center" class="container-padding" width="100%"
                                                        style="width:100%;max-width:100%;">
                                                        <tr>
                                                            <td class="rwd-col" align="center" valign="top"
                                                                width="31.03%" style="width:31.03%;max-width:31.03%;">

                                                                <!-- column -->
                                                                <table border="0" align="center" cellpadding="0"
                                                                    cellspacing="0" role="presentation"
                                                                    width="100%" style="width:100%;max-width:100%;">
                                                                    <tr data-element="blue-content-titles"
                                                                        data-label="Titles">
                                                                        <td class="center-text"
                                                                            data-text-style="Titles" align="right"
                                                                            style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:20px;line-height:24px;font-weight:700;font-style:normal;color:#333333;text-decoration:none;letter-spacing:0px;">
                                                                            <singleline>
                                                                                <div mc:edit data-text-edit>
                                                                                    Shipping details
                                                                                </div>
                                                            ...
                                                            <td class="rwd-col" align="center" width="3.45%"
                                                                height="10"
                                                                style="width:3.45%;max-width:3.45%;height: 10px;">
                                                                &nbsp;</td>
                                                            <td class="rwd-col" align="center" valign="top"
                                                                width="65.52%" style="width:65.52%;max-width:65.52%;">

                                                                <!-- column -->
                                                                <table border="0" align="center" cellpadding="0"
                                                                    cellspacing="0" role="presentation"
                                                                    width="100%" style="width:100%;max-width:100%;">
                                                                    <tr data-element="blue-content-paragraph"
                                                                        data-label="Paragraphs">
                                                                        <td class="hide-mobile" align="center"
                                                                            width="20"
                                                                            style="width:20px;max-width:20px;border-left: 1px solid #000000;">
                                                                        </td>
                                                                        <td class="center-text"
                                            ...
                                            <tr data-element="blue-shipping-details" data-label="Shipping details">
                                                <td height="20" style="font-size:20px;line-height:20px;"
                                                    data-height="Spacing under shipping details">&nbsp;</td>
                                            </tr>
                                                                ...
                                                                <table border="0" align="center" cellpadding="0"
                                                                    ...
                                                                    <tr data-element="blue-content-paragraph"
                                                                        ...
                                                                        <td class="center-text"
                                                                            ...
                                                                            <singleline>
                                                                                <div mc:edit data-text-edit>
                                                                                    {{ $content->delivered_at ? $content->delivered_at->format('d F Y') : 'On Process' }}
                                                                                    </p>
                                                                                </div>
                                                                            </singleline>
                                                                        </td>
                                            ...
                                            <tr data-element="blue-tracking-number" data-label="Tracking Number">
                                                <td align="center">
                                                    <!-- rwd-col -->
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        align="center" class="container-padding" width="100%"
                                            ...
                                            <tr data-element="blue-courier" data-label="Courier">
                                                <td align="center">
                                                    <!-- rwd-col -->
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        align="center" class="container-padding" width="100%"
                ...
                <table data-outer-table border="0" align="center" cellpadding="0" cellspacing="0"
                        ...
                        <td align="center" bgcolor="#FFFFFF" data-bgcolor="BgColor" class="container-padding">
                            ...
                            <table border="0" align="center" cellpadding="0" cellspacing="0"
                                ...
                                <tr data-element="blue-title-titles" data-label="Titles">
                                    <td class="center-text" data-text-style="Titles" align="center"
                                        style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:24px;line-height:36px;font-weight:700;font-style:normal;color:#4600ff;text-decoration:none;letter-spacing:0px;">
                                        <singleline>
                                            <div mc:edit data-text-edit>
                                                Products on cart
                                            </div>
                    ...
                    <tr>
                        <td height="5" style="font-size:5px;line-height:5px;" data-height="Spacing bottom">&nbsp;
                        </td>
                    </tr>
                </table>
                <!-- blue-title -->

                @foreach ($content->order->products as $product)
                    <table data-outer-table border="0" align="center" cellpadding="0" cellspacing="0"
                        class="outer-table row" role="presentation" width="640"
                        style="width:640px;max-width:640px;" data-module="blue-product-1">
                        <!-- blue-product-1 -->
                        <tr>
                            <td height="5" style="font-size:5px;line-height:5px;" data-height="Spacing top">
                                &nbsp;
                            </td>
                        </tr>
                        <tr>
                                    ...
                                    <tr>
                                        <td align="center" bgcolor="#F8F8F8" data-bgcolor="Inner BgColor">
                                            ...
                                            <table border="0" cellpadding="0" cellspacing="0" align="center"
                                                class="row container-padding" width="90.63%"
                                                ...
                                                <tr>
                                                    <td class="rwd-col" align="center" width="31.03%"
                                                        ...
                                                        <table border="0" align="center" cellpadding="0"
                                                            ...
                                                            style="width:100%;max-width:100%;">
                                                            <tr data-element="blue-content-picture"
                                                                data-label="Picture">
                                                                <td align="center">
                                                                    <img class="auto-width"
                                                                        style="display:block;width:100%;max-width:100%;"
                                                                        data-image-edit data-url data-label="Picture"
                                                                        data-border-radius-default="0,6,36"
                                                                        data-border-radius-custom="Pictures"
                                                                        width="180" src="{{ $product->image1() }}"
                                                                        border="0" editable="true"
                                                                        alt="picture">
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    ...
                                                    <td class="rwd-col" align="center" width="3.45%" height="30"
                                                        style="width:3.45%;max-width:3.45%;height: 30px;">&nbsp;</td>
                                                    <td class="rwd-col" align="center" width="65.52%"
                                                        ...
                                                        <table border="0" align="center" cellpadding="0"
                                                            ...
                                                            <tr data-element="blue-content-titles"
                                                                data-label="Titles">
                                                                <td class="center-text" data-text-style="Titles"
                                                                    align="left"
                                                                    style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:20px;line-height:24px;font-weight:700;font-style:normal;color:#333333;text-decoration:none;letter-spacing:0px;">
                                                                    <singleline>
                                                                        <div mc:edit data-text-edit>
                                                            ...
                                                            <tr data-element="blue-content-paragraph"
                                                                ...
                                                                <td class="center-text" data-text-style="Paragraphs"
                                                                    align="left"
                                                                    style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:16px;line-height:24px;font-weight:400;font-style:normal;color:#333333;text-decoration:none;letter-spacing:0px;">
                                                                    <singleline>
                                                                        <div mc:edit data-text-edit>
                                                                            {{ $product->description }}
                                                                        </div>
                                                            ...
                                                            <tr data-element="blue-content-paragraph"
                                                                ...
                                                                <td height="10"
                                                                    ...
                                                                    data-height="Spacing under paragraphs">&nbsp;</td>
                                                            </tr>

                                                            <tr data-element="blue-content-option-2"
                                                                data-label="2nd Option">
                                                                <td class="center-text" data-text-style="Options"
                                                                    align="left"
                                                                    style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:16px;line-height:24px;font-weight:400;font-style:normal;color:#333333;text-decoration:none;letter-spacing:0px;">
                                                                    <singleline>
                                                                        <div mc:edit data-text-edit>
                                                            ...
                                                            <tr data-element="blue-content-option-3"
                                        ...
                                        <table border="0" align="center" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr data-element="blue-subtotal" data-label="Subtotal">
                                                <td align="center">
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="rwd-col" align="center" valign="top"
                                                                width="50%" style="width:50%;max-width:50%;">
                                                                ...
                                                                <table border="0" align="center" cellpadding="0"
                                                                    ...
                                                                    <tr data-element="blue-content-titles"
                                                                        ...
                                                                        <td class="hide-mobile" align="center"
                                                                            width="20" height="40"
                                                                            style="width:20px;max-width:20px;height: 40px;">
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                                <!-- column -->
                                                            ...
                                                            <td class="rwd-col" align="center" valign="top"
                                                                ...
                                                                <table border="0" align="center" cellpadding="0"
                                                                    cellspacing="0" role="presentation"
                                                                    class="m-padding-top10" width="100%"
                                                                    style="width:100%;max-width:100%;">
                                                                    <tr data-element="blue-content-paragraph"
                                                                        data-label="Paragraphs">
                                                                        <td class="hide-mobile" align="center"
                                                                            width="20" height="40"
                                                                            style="width:20px;max-width:20px;border-left: 1px solid #000000;height: 40px;">
                                                                        </td>
                                                                        <td class="center-text"
                                                                            data-text-style="Paragraphs"
                                                                            align="left"
                                                                            ...
                                                                            <singleline>
                                                                                <div mc:edit data-text-edit>
                                                                                    Rp.{{ number_format($content->order->transaction->item_total_price, 2, ',', '.') }}
                                                                                </div>
                                                                            </singleline>
                                                                        </td>
                                                                    </tr>
                                            ...
                                            <tr data-element="blue-subtotal" data-label="Subtotal">
                                                <td height="10" style="font-size:10px;line-height:10px;"
                                                    data-height="Spacing under subtotal">&nbsp;</td>
                                            </tr>
                                                                ...
                                                                <table border="0" align="center" cellpadding="0"
                                                                    ...
                                                                    <tr data-element="blue-content-paragraph"
                                                                        ...
                                                                        <td class="center-text"
                                                                            ...
                                                                            <singleline>
                                                                                <div mc:edit data-text-edit>
                                                                                    Rp.{{ number_format($content->order->transaction->tax, 2, ',', '.') }}
                                                                                </div>
                                                                            </singleline>
                                                                        </td>
                                                                    </tr>
                                                                ...
                                                                <table border="0" align="center" cellpadding="0"
                                                                    ...
                                                                    <tr data-element="blue-content-paragraph"
                                                                        ...
                                                                        <td class="center-text"
                                                                            ...
                                                                            <singleline>
                                                                                <div mc:edit data-text-edit>
                                                                                    Rp.{{ number_format($content->order->transaction->shipping_price, 2, ',', '.') }}
                                                                                </div>
                                                                            </singleline>
                                                                        </td>
                                                                    </tr>
                                                                ...
                                                                <table border="0" align="center" cellpadding="0"
                                                                    ...
                                                                    <tr data-element="blue-content-paragraph"
                                                                        ...
                                                                        <td class="center-text"
                                                                            ...
                                                                            <singleline>
                                                                                <div mc:edit data-text-edit>
                                                                                    Rp.{{ number_format($content->order->transaction->total_price, 2, ',', '.') }}
                                                                                </div>
                                                                            </singleline>
                                                                        </td>
                                                                    </tr>
                                            ...
                                            <tr data-element="blue-tax" data-label="Tax">
                                                <td height="30" style="font-size:30px;line-height:30px;"
                                                    data-height="Spacing under tax">&nbsp;</td>
                                            </tr>
                                            ...
                                            <tr data-element="blue-content-total" data-label="Total">
                                                <td align="center">
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="rwd-col" align="center" valign="top"
                                                                width="49%" style="width:49%;max-width:49%;">
                                                                ...
                                                                <table border="0" align="right" cellpadding="0"
                                                                    ...
                                                                    <tr>
                                                                        <td align="center"
                                                                            data-border-radius-default="0,6,36"
                                                                            data-border-radius-custom="Order Number"
                                                                            data-bgcolor="Order Number"
                                                                            bgcolor="#F8F8F8"
                                                                            style="border-radius: 0px; border: 2px solid #EEEEEE;">
                                                                            <!-- Container -->
                                                            ...
                                                            <td class="rwd-col" align="center" valign="top"
                                                                width="2%" height="20"
                                                                style="width:2%;max-width:2%;height: 20px;"></td>
                                                            <td class="rwd-col" align="center" valign="top"
                                                                width="49%" style="width:49%;max-width:49%;">
                                                                ...
                                                                <table border="0" cellspacing="0" cellpadding="0"
                                                                    ...
                                                                    <tr>
                                                                        <td align="center"
                                                                            ...
                                                                            data-bgcolor="Buttons" bgcolor="#4600ff"
                                                                            style="border-radius: 0px; border: 2px solid #4600ff;">
                                                                            <!--[if (gte mso 9)|(IE)]>
              <table border="0" cellpadding="0" cellspacing="0" align="center">
                <tr>
                  ...
                  <![endif]-->
                                                                            <singleline>
                                                                                <a href="{{ route('customer.dashboard.shipping.index') }}"
                                                                                    ...
                                                                                    style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:20px;line-height:24px;font-weight:700;font-style:normal;color:#FFFFFF;text-decoration:none;letter-spacing:0px;padding: 15px 35px 15px 35px;display: inline-block;"><span>Confirmation
                                                                                        Order</span></a>
                                                                            </singleline>
                                                                            <!--[if (gte mso 9)|(IE)]>
                  </td>
                                        ...
                                        <table border="0" align="center" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr>
                                                <td class="center-text" data-text-style="Paragraphs" align="center"
                                                    ...
                                                    <multiline>
                                                        <div mc:edit data-text-edit>
                                                            © {{ now()->format('Y') }} Matahari Songket Bali.. All
                                                            Rights Reserved.<br>
                                                            Jalan Matahari Lingkungan Kemoning Klod, Klungkung, Bali,
                                                            Indonesia
                                                        </div>
                                                    </multiline>
                                                </td>
