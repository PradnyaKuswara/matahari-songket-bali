            ...
            <td align="center" data-bgcolor="Body" bgcolor="#FFFFFF" data-composer>
              ...
              <table border="0" cellpadding="0" cellspacing="0" align="center">
                <tr>
                  ...
                  <![endif]-->
                                                                            <singleline>
                                                                                <a href="{{ route('customer.dashboard.order.show', $content->order) }}"
                                                                                    mc:edit data-button
                                                                                    data-text-style="Buttons"
                                                                                    style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:20px;line-height:24px;font-weight:700;font-style:normal;color:#FFFFFF;text-decoration:none;letter-spacing:0px;padding: 15px 35px 15px 35px;display: inline-block;"><span>Show
                                                                                        Order</span></a>
                                                                            </singleline>
                                                                            <!--[if (gte mso 9)|(IE)]>
                  </td>
