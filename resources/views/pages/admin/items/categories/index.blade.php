...
@section('content')
    <x-dashboard.page-title header="Management Item Category" subtitle="Item Category" :linkSubTitle="route('admin.dashboard.items.categories.index')" title="Index"
        :linkTitle="route('admin.dashboard.items.categories.index')"></x-dashboard.page-title>
            ...
            <div class="card bg-white shadow-lg rounded-lg text-center">
                <div class="card-body">
                    <div class="card-actions mb-4 items-center w-full justify-between">
                        ...
                        <label class="input input-bordered input-mdw-full md:w-80  flex items-center gap-2">
