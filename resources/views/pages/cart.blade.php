        ...
        <div class="grid lg:grid-cols-4 gap-8">
            <div class="md:col-span-3 lg:col-span-3">
                <div x-data="{ checkAll: false }" x-init="checkAll = false" class="flex flex-col gap-4">
                    <div class="flex justify-between items-center w-full border border-slate-400 rounded-md p-4">
                    ...
                    <div
                        class="flex flex-col w-full border border-slate-400 rounded-md p-4 2xl:h-[49rem] h-[33rem] overflow-y-scroll">
            ...
            <div class="md:col-span-3 lg:col-span-1  ">
                <div class="flex flex-col gap-8 ">
                    <div class="flex flex-col gap-4 border border-slate-400 rounded-md p-4 ">
                        ...
                        <x-button-click class="btn-sm bg-accent text-white">Checkout</x-button-click>
                    </div>
                    <div class="flex flex-col gap-4 border border-slate-400 rounded-md p-4">
                        <h1 class="text-lg font-bold">Need Help?</h1>
                        <p class="text-sm">If you have any question, feel free to contact us</p>
                        <x-button-click class="btn-sm bg-accent text-white">Contact Us</x-button-click>
                    </div>
                </div>
            </div>
        </div>
