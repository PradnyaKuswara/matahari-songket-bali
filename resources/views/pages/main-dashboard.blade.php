...
@section('content')
    <x-dashboard.page-title header="Main Dashboard" subtitle="Page" :linkSubTitle='route($linkSubtitle)' title="Main"
        :linkTitle="route($linkSubtitle)"></x-dashboard.page-title>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card shadow-lg bg-white">
                <div class="p-5">
                    ...
                    <span
                        class="inline-flex items-center gap-1.5 py-0.5 px-1.5 text-xs font-medium bg-warning text-white rounded me-1">
                        0% </span> <span class="text-muted">From previous period</span>
                </div>
            </div>
        </div>
            ...
            <div class="card shadow-lg bg-white">
                <div class="p-5">
                    <div class="flex justify-between items-center">
                        ...
                        <div class="relative">
                            <button class="text-lg text-gray-600 p-2" data-fc-placement="left-start" data-fc-type="dropdown"
                                type="button">
                                <i class="mdi mdi-dots-vertical"></i>
                            </button>

                            <div
                                class="hidden z-10 bg-white w-44 shadow rounded border p-2 transition-all duration-300 fc-dropdown-open:translate-y-0 translate-y-3">
                    ...
                    <div class="flex text-center mt-4">
                        <div class="w-1/2">
                            <h4 class="text-xl">5,459</h4>
                            <p class="text-muted">Total Sales</p>
                        </div>
                        <div class="w-1/2">
                            <h4 class="text-xl">18</h4>
        ...
        <div class="col-xl-3 col-md-6">
            ...
            <div class="card shadow-lg bg-white">
                <div class="p-5">
                    ...
                    <div class="flex text-center mt-4">
                        <div class="w-1/2">
                            <h4 class="text-xl">$1875.54</h4>
                            <p class="text-muted">Revenue</p>
                        </div>
                        <div class="w-1/2">
                            <h4 class="text-xl">541</h4>
            ...
            <div class="card shadow-lg bg-white">
                <div class="p-5">
                    <div class="flex justify-between items-center">
                        ...
                        <div class="relative">
                            <button class="text-lg text-gray-600 p-2" data-fc-placement="left-start"
                                    ...
                                    <td class="px-6 py-3">
                                        <div class="flex w-full h-1.5 bg-light rounded-full overflow-hidden">
                                            <div class="progress-bar progress-bar-striped bg-success" role="progressbar"
                                                aria-valuenow="85" aria-valuemin="20" aria-valuemax="100"
                                                style="width:85%"></div>
                                        </div>
                                    </td>
