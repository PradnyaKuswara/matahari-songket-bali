...
@section('page-title')
    Product Detail | Matahari Songket Bali
@endsection
...
@section('content')
    ...
    @if ($products->count() > 0)
        <section class="xl:max-w-screen-xl lg:max-w-screen-lg mx-1 md:mx-8 lg:mx-auto pb-16">
            <div class="flex flex-col gap-8 lg:gap-4">
                <div class="text-2xl md:text-4xl font-bold">You may like also</div>
                <div x-data="{ card: false, loading: false }" x-init=" card = true, loading = false" class="grid grid-cols-2 lg:grid-cols-4 gap-2  lg:mx-0 lg:gap-8">
